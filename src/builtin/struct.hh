...
static value_ptr _struct_constructor(value_type_ptr v, ast_node_ptr node)
{
	// TODO: zero value
...
static value_ptr builtin_macro_struct(ast_node_ptr node)
{
	...
	(use_scope(new_scope), compile(node));
